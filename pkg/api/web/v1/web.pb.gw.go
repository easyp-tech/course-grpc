...
func request_YourService_EchoStream_0(ctx context.Context, marshaler runtime.Marshaler, client YourServiceClient, req *http.Request, pathParams map[string]string) (YourService_EchoStreamClient, runtime.ServerMetadata, chan error, error) {
...
func RegisterYourServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server YourServiceServer) error {
	...
	mux.Handle(http.MethodPost, pattern_YourService_EchoStream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterYourServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client YourServiceClient) error {
	...
	mux.Handle(http.MethodPost, pattern_YourService_EchoStream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/your.service.v1.YourService/EchoStream", runtime.WithHTTPPathPattern("/v1/example/echo/stream"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}

		resp, md, reqErrChan, err := request_YourService_EchoStream_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_YourService_EchoStream_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	})
	return nil
}
...
var (
	...
	pattern_YourService_EchoStream_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "example", "echo", "stream"}, ""))
)

var (
	forward_YourService_Echo_0       = runtime.ForwardResponseMessage
	forward_YourService_EchoStream_0 = runtime.ForwardResponseStream
)
